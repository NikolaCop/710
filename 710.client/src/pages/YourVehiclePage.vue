  ...
  <div class="container-fluid bg-dark">
        ...
        <div class="vehicle-rounded">
          <div class="row justify-content-center">
            ...
            <div class="col-7 col-sm-7 col-md-6 col-lg-5 col-xl-4 text-center">
              <img src="../assets/img/porsche.png" class="card-img-top img-fluid mt-2 animate__animated animate__fadeInLeft">
            </div>
          </div>
          <div class="row justify-content-center">
            <div class="col-10">
                  ...
                  <div class="col-9 p-2 text-center">
                    <div class="row justify-content-center">
                      <div class="col-12 col-sm-11 col-md-10 col-lg-9 col-xl-8">
                        <div class="row justify-content-center">
                          <div class="col-4">
                            <button class="btn btn-outline-primary button animate__animated animate__fadeInLeft">
                              <i class="fa fa-pencil text-light pam-size mt-2 mb-2"
                                 data-toggle="modal"
                          ...
                          <EditVehicleModal />
                          <div class="col-4">
                            <button class="btn btn-outline-danger button animate__animated animate__fadeInRight">
                              <i class="fa fa-file-archive-o  pam-size text-light mt-2 mb-2" @click="archiveVehicle" aria-hidden="true"></i>
                            </button>
                          </div>
                          <div class="col-4">
                            <button class="btn btn-outline-secondary button animate__animated animate__fadeInUp">
                              <i
    ...
    <div class="row justify-content-around mt-3">
      <div class="col-10 col-sm-10 col-md-8 col-lg-6 text-center">
        <div class="card shadow-lg maintenance-card p-2 bg-primary animate__animated animate__fadeInUp">
      ...
      <div class="col-10 col-sm-10 col-md-8 col-lg-6 col-xl-6">
        <div class="card card-holding-router-links p-2 bg-warning shadow-lg">
          ...
          <div class="row justify-content-center mt-2">
            <div class="col-5 card blank-size text-center bg-info mr-2 animate__animated animate__fadeInLeft">
              <h6 class="text-light"></h6>
            </div>
            <div class="col-2 card blank-size text-center bg-light ml-2 animate__animated animate__fadeInLeft">
              <h6 class="text-light"></h6>
            </div>
          </div>
          ...
          <div class="row justify-content-center mt-2">
            <div class="col-2 card blank-size text-center bg-light mr-2 animate__animated animate__fadeInRight">
              <h6 class="text-light"></h6>
            </div>
            <div class="col-5 card blank-size text-center bg-info ml-2 animate__animated animate__fadeInRight">
              <h6 class="text-light"></h6>
            </div>
          </div>
          <div class="row justify-content-around mt-2">
          ...
          <div class="row justify-content-center mt-2 mb-2">
            <div class="col-3 blank-size card shadow-sm text-center bg-light mr-2 animate__animated animate__fadeInLeft animate__delay-.5s">
              <h6 class="text-light"></h6>
            </div>
            <div class="col-1 card  blank-size shadow-sm  text-center bg-secondary ml-1 mr-2 animate__animated animate__fadeInRight animate__delay-.75s">
              <h6 class="text-light"></h6>
            </div>
            <div class="col-3 card shadow-sm blank-size  text-center ml-1 bg-info animate__animated animate__fadeInUp animate__delay-.8s">
              <h6 class="text-light"></h6>
            </div>
            <div class="col-1 card shadow-sm blank-size text-center ml-2 bg-dark animate__animated animate__fadeInDown animate__delay-1.25s">
              <h6 class="text-light"></h6>
            </div>
          </div>
        </div>
